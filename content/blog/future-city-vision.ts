...
export const post: BlogPost = {
  ...
  title: "Telangana's Future City and the Long Game for Land",
  metaTitle: "Telangana's Future City and the Long Game for Land",
  metaDescription:
    "Telangana has announced a planned city south of the airport. What the announcement contains, what history charges for new cities, and how to position.",
  keywords: [
    "Future City Telangana",
    "Fourth City Hyderabad",
    "Future City Mucherla",
    "planned city south Hyderabad",
    "Hyderabad long term land investment",
    "Mansanpally corridor",
  ],
  ...
  body: `India has conjured cities from open land before. Chandigarh was drawn on paper and built on farmland. Navi Mumbai was planned across the harbour as a counter-magnet to a city that had run out of room. GIFT City rose on a riverbank in Gujarat as a financial enclave with its own rulebook.
...
We track this class of question across projects in our [survey of Hyderabad's infrastructure pipeline](/blog/infrastructure-projects-hyderabad), and the discipline is the same everywhere: separate the sanctioned from the announced.
...
Those three rules are why a corridor with a working present tense — the kind where 45 acres already carry underground water, electricity and drainage, as at [Sanctuary](/projects/sanctuary) — is a different asset class from a corridor whose case is entirely prospective, even when both sit near something large that has been announced.
...
If those three cannot be produced on paper, the plot is being sold on a story. Stories are subject to revision; registered deeds are not. Land investment is in any case subject to market conditions, and verification of title and approvals stays with the buyer regardless of how large the project on the horizon happens to be. Walk the ground, read the file, and let the state prove its schedule before you price it in.`,
  ...
  faqs: [
    {
      q: "What exactly is Telangana's Future City?",
      a: "A stated government intention to develop a large planned city on a southern axis beyond Rajiv Gandhi International Airport, framed around modern zoning, sustainability and dedicated institutional and industrial districts. The concept and general geography are public; notified boundaries, a published master plan and sequenced contracts are the things to watch for next.",
    },
    {
      q: "How long do planned cities like this usually take?",
      a: "Historically, decades rather than budget cycles. Chandigarh, Navi Mumbai and GIFT City all eventually worked, and all took considerably longer than their announcements implied. Trunk infrastructure and institutional anchors come first, and organic residential demand comes last.",
    },
    {
      q: "Does a new southern city weaken West Hyderabad?",
      a: "Not on any horizon a current buyer is operating in. The western employment core is built, staffed and surrounded by two decades of accumulated schools, hospitals and suppliers. A second growth pole usually enlarges a metropolitan region rather than redistributing it — the Delhi and Mumbai precedents both point that way.",
    },
    {
      q: "Should I buy land purely because it is near the announced area?",
      a: "No. Buy land that makes sense on today's roads, employment and approvals, so that a future city is optionality rather than the whole thesis. Land bought only on an announcement exposes you to a government's execution schedule, which no buyer controls.",
    },
    {
      q: "What single indicator best tracks whether the project is real?",
      a: "The development authority. A constituted authority with notified jurisdiction, a published draft master plan open to objections, and awarded trunk infrastructure contracts is evidence. Renders and vision documents are not — they commit nobody and cost almost nothing to produce.",
    },
  ],
};
